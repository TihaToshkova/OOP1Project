/**
 * The {@code CreateJediInterface} defines a method to create and add a Jedi to a specified planet.
 */
public interface CreateJediInterface {

    /**
     * Creates a new Jedi with the specified attributes and adds them to the specified planet managed by {@code FileOperations}.
     * <p>
     * If the specified planet does not exist in the collection managed by {@code FileOperations}, this method prints an error message
     * and does not create the Jedi. Otherwise, it creates a new Jedi object with the provided attributes (name, rank, age, saber color,
     ...
     * @param planetName     the name of the planet where the Jedi will be added
     * @param jediName       the name of the Jedi to be created
     * @param jediRank       the rank of the Jedi (e.g., "MASTER", "KNIGHT")
