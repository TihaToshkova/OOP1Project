...
/**
 * The {@code Operations.FileOperations} class manages file-related operations and the collection of planets.
 * <p>
...
public class FileOperations {
     ...
     *
     * @return a map where the keys are planet names and the values are {@code Planet.Planet} objects
     */
     ...
     *
     * @param planets a map where the keys are planet names and the values are {@code Planet.Planet} objects
     */
