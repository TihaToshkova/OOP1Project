...
/**
 * The {@code Operations.Help} class provides a method to print out a list of supported commands and their descriptions.
 * <p>
 * This class implements the {@code Operations.HelpInterface} interface.
 * </p>
 */
public class Help implements HelpInterface {
    ...
    public void execute() {
        ...
        System.out.println("get_strongest_jedi <planet_name> - Get the strongest Jedi.Jedi on a planet.");
        System.out.println("get_youngest_jedi <planet_name> <jedi_rank> - Get the youngest Jedi.Jedi by rank on a planet.");
    }
}
