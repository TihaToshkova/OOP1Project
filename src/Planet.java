...
/**
 * The {@code Planet} class represents a planet with a name and a population of jedis.
 */
public class Planet {
    private String name;
    ...
    /**
     * Adds a Jedi to the population of the planet.
     *
     * @param jedi the Jedi to add to the planet
     */
    ...
    /**
     * Removes a Jedi from the population of the planet based on the Jedi's name (case-insensitive).
     *
     * @param jediName the name of the Jedi to remove
     * @return {@code true} if the Jedi was removed successfully, {@code false} otherwise
     */
