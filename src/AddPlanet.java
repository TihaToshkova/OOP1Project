/**
 * The {@code AddPlanet} class provides a method to add a planet to a collection
 * of planets managed by {@code FileOperations}.
 * <p>
 * This class implements the {@code AddPlanetInterface} interface.
 * </p>
 */
public class AddPlanet implements AddPlanetInterface{
     ...
     * If the planet does not exist, it creates a new {@code Planet} object with the given name
