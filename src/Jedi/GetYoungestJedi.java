...
/**
 * The {@code Jedi.Jedi.GetYoungestJedi} class provides a method to find the youngest Jedi.Jedi of a specified rank on a given planet
 * managed by {@code Operations.FileOperations}.
 * <p>
 * This class implements the {@code Jedi.Jedi.GetYoungestJediInterface} interface.
 * </p>
 */
public class GetYoungestJedi implements GetYoungestJediInterface {

    /**
     * Finds and prints the youngest Jedi.Jedi of a specified rank on a given planet.
     * <p>
     ...
     * an appropriate error message. Otherwise, it prints the name and age of the youngest Jedi.Jedi with the specified rank.
     * </p>
     *
   ...
   public void execute(FileOperations fileOperations, String planetName, String jediRank) {
       ...
       Optional<Jedi> youngestJedi = jedis.stream()
           ...
           System.out.println("The youngest Jedi.Jedi with rank " + jediRank + " on planet " + planetName + " is " + jedi.getJediName() + " with age " + jedi.getAge() + ".");
   }
}