...
/**
 * The {@code Jedi.RemoveJedi} class implements {@code Jedi.RemoveJediInterface} to remove a Jedi.Jedi from a planet.
 */
public class RemoveJedi implements RemoveJediInterface {
    ...
    public void execute(FileOperations fileOperations, String jediName, String planetName) {
        ...
        if (planet.removeJedi(jediName)) {
            System.out.println("Jedi.Jedi successfully removed from planet " + planetName + ": " + jediName);
        } else {
            System.out.println("Error: Jedi.Jedi not found on planet " + planetName + ": " + jediName);
        }
    }
}
