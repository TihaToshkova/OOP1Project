...
/**
 * The {@code PrintTwoPlanets} class implements {@code PrintTwoPlanetsInterface} to print details of jedis from two specified planets.
 */
public class PrintTwoPlanets implements PrintTwoPlanetsInterface {

    /**
     * Prints details of jedis from two specified planets, sorted by rank and then by Jedi name.
     *
    ...
    public void execute(FileOperations fileOperations, String planetName1, String planetName2) {
        ...
        // Sorting combined jedis by rank and then by Jedi name
